<template>
  <div>
    ...
    <div class="content_follow">
      <div class="inner">
        <div class="tit">明星认证</div>
        <div class="mxrz">
          明星认证需要明星本人提供身份证或其工作室提供营业执照即可
        </div>
        <div class="upload">
          <div class="starYyzz">
            <img :src="pageImg" class="left" />
            <div class="right">
              <div class="dljm">工作室营业执照</div>
          ...
          <div class="card_img">
            <ul>
              <li class="card_left">
                <img :src="avatarFront" class="left" />
                <div class="right">
                  <div>上传证件正面照2M</div>
                  <a href="javascript:;" class="file">
                    点击上传
...
export default {
  data() {
    return {
      ...
      avatarFront: require("../assets/images/home/card_z.png"),
